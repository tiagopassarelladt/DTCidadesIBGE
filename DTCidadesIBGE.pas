...
uses
 ...
 const
 URL_Municipios      = 'https://servicodados.ibge.gov.br/api/v1/localidades';
...
begin
    try
      ...
      try
        Response := HttpClient.Get( URL_Municipios + '/municipios',
                      nil,
                      nil
                      );
        Cidades.Clear;
...
begin
    try
      ...
      try
        Response := HttpClient.Get( URL_Municipios + '/estados/' + UpperCase( UF ) + '/municipios',
                      nil,
                      nil
                      );
        Cidades.Clear;
